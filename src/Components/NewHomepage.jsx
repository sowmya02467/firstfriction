...
<div className="one flex sm:flex-col md:flex-row items-center justify-center w-full sm:w-[361px] h-auto sm:h-[72px] mt-[20px] sm:mt-[120px]">
    ...
    <div className="one flex sm:flex-col md:flex-row items-center justify-center w-full sm:w-[361px] h-auto sm:h-[72px] mt-[20px] sm:mt-[120px] ">
      ...
      <section   className="w-full h-auto mx-0 mt-[82px] min-w-screen-lg px-4  "> 
          ...
          <div className="flex flex-col justify-center text-center">
            <h2 className="text-[#FF5C00] mt-[52px] text-[30px] font-black">Our Strategic Success Framework</h2>
            <h3 className="text-[40px] text-[#241443] font-semibold mt-[10px]">
  ...
  <h2 className="text-[#241443] text-[32px] lg:text-[40px] md:text-[52px] sm:text-[52px] sm:w-[414px] font-semibold font-sans font-lato w-full md:w-[616px] sm:text-start md:text-start">
    1. Engaging Learning Experience
  </h2>
  <p className="lg:w-[513px] text-[20px] lg:text-[20px] sm:text-[12px] sm:w-[333px] md:text-[16px] font-medium text-[#FF5C00] mt-[31px] md:ml-[16px]   lg:text-center sm:text-start md:text-start">
    "FrictionLearn” transforms traditional education into an engaging, fun, and motivating gamified learning journey".
            ...
            <div className="flex flex-col-reverse lg:flex-row lg:justify-evenly lg:space-x-9 lg:mt-[50px] md:space-x-0 md:space-y-[50px]">
              ...
              <div className="content flex flex-col justify-center text-center md:mt-[20px] lg:mr-[-110px]">
                <h2 className="text-[#241443] text-[32px]   lg:text-[40px] md:text-[82px]  sm:text-[82px]  sm:w-[414px]      font-semibold font-sans font-lato w-full md:w-[616px]">
                  2. Structured Course Levels:
                </h2>
                <p className="   lg:w-[513px] text-[20px] lg:text-[20px] sm:text-[12px] sm:w-[212px] md:text-[16px]  font-medium text-[#FF5C00] mt-[31px] md:ml-[16px]">
            ...
            <div className="flex flex-col-reverse lg:flex-row lg:justify-evenly lg:space-x-9 md:space-x-0 md:space-y-[50px]">
              ...
              <div className="content flex flex-col justify-center text-center mt-[50px] md:ml-[0px] w-full md:w-[572px] h-[219px]">
                ...
                <p className="   lg:w-[513px] text-[20px] lg:text-[20px] sm:text-[12px] sm:w-[212px] md:text-[16px]  font-medium text-[#FF5C00] mt-[31px] md:ml-[16px]  mb-[60px]">
...
<div className="flex flex-col justify-center items-center text-center mt-[182px] sm:mt-[40px]">
  ...
  <h2 className="text-[#241443] text-[40px] sm:text-[50px] md:text-[40px]  font-semibold text-center font-poppines">
    Doing this Projects will Gain Hands-On real<br /> World Project Experience with <span className="text-[#FF5C00] text-[40px]">Friction</span>Learn
  </h2>
</div>
...
<section className="main w-full  sm:h-auto">
  ...
  <div className="flex flex-col justify-center items-center text-center mt-[182px] sm:mt-[40px] md:mt-[60px]">
    ...
    <h2 className="text-[#241443] text-[40px] font-bold text-center font-poppines">
      Digitize your resume, unlock opportunities, and <br />streamline placements with our tech-driven<br />passport
    </h2>
  </div>

  <div className="parent flex flex-col sm:flex-row sm:justify-center md:justify-between mt-[100px]">

    <div className="childleft sm:w-full md:w-1/2 px-[10px]  ml-[50px]">
      <h6 className="text-[#FF5C00] text-[22px] font-bold font-poppines line-height-[32px] text-start">Benefits of Passport/License</h6>
      <p className="text-[#000000] text-[20px] font-medium font-poppines line-height-[32px] text-start mt-[20px]">
      ...
      <div className="allpoints flex flex-col-2 gap-4 mt-[69px] ">
        ...
        <div className="space-y-8">
          ...
          <div className="w-[24px] h-[24px] bg-[#FF5C00] rounded-full flex items-center justify-center">
            ...
            <h4 className="text-[22px] text-[#241443] font-medium"> "Verified Career Credentials"</h4>
          </div>
          ...
          <div className="w-[24px] h-[24px] bg-[#FF5C00] rounded-full flex items-center justify-center">
            ...
            <h4 className="text-[22px] text-[#241443] font-medium"> "QR-Linked Resume"</h4>
          </div>
          ...
          <div className="w-[24px] h-[24px] bg-[#FF5C00] rounded-full flex items-center justify-center">
            ...
            <h4 className="text-[22px] text-[#241443] font-medium"> "Level-Based Certification"</h4>
          </div>
          ...
          <div className="w-[24px] h-[24px] bg-[#FF5C00] rounded-full flex items-center justify-center">
            ...
            <h4 className="text-[22px] text-[#241443] font-medium"> "Streamlined Job Placement"</h4>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="w-[24px] h-[24px] bg-[#FF5C00] rounded-full flex items-center justify-center">
            ...
            <h4 className="text-[22px] text-[#241443] font-medium"> "Tech-Driven Advancement"</h4>
          </div>
          ...
          <div className="w-[24px] h-[24px] bg-[#FF5C00] rounded-full flex items-center justify-center">
            ...
            <h4 className="text-[22px] text-[#241443] font-medium"> "Job-Ready Access"</h4>
          </div>

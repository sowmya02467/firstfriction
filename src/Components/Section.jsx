...
export default function Section() {
  ...
  return (
    ...
    //   <img src={line} alt="" className='h-[140px] w-[13px] text-center  hidden sm:hidden lg:block'/>
    // </div>

    // <div className='flex flex-row ml-[730px] mt-[-120px] '>
    //   <img src={line} alt="" className='h-[252px] w-[8px] text-center rotate-90 hidden sm:hidden lg:block'/>
    // </div>
    ...
    // <div  className='flex felx-col  ml-[200px] mt-[20px]  hide-on-mobile    hidden sm:hidden  lg:block'><img src={line} alt=""   className='h-[150px] w-[13px] text-center'/></div>
    // <div  className='flex felx-row  ml-[300px] mt-[-100px]   hide-on-mobile   hidden sm:hidden  lg:block'><img src={line} alt=""   className='h-[192px] w-[8px] text-center -rotate-90 '/></div>
    ...
    // <div  className='flex flex-col  ml-[850px] mt-[-10px]   hide-on-mobile   hidden sm:hidden  lg:block'><img src={line} alt=""   className='h-[150px] w-[13px] text-center'/></div>
    // <div  className='flex flex-row  ml-[760px] mt-[-100px]    hide-on-mobile  '><img src={line} alt=""   className='h-[192px] w-[8px] text-center rotate-90 '/></div>
    ...
    <div className='w-full flex flex-col h-auto mt-[100px] mb-[50px]'>

      <div className=" flex flex-col justify-center text-center mb-[50px]">
      <div  className="flex items-center justify-center">
      <img src={star} alt="star" className="w-[36px] h-[36px] mr-[-10px] mt-[75px]" />
        <h2 className="text-[#FF5C00] mt-[82px] text-[30px] font-black ">How the Process?</h2>
        </div>
        <p className="px-1 sm:px-4 text-[22px] sm:text-[30px] lg:text-[40px]  text-[#241443] font-bold mt-[40px]">Find Your Idea to get Life in Real World with Our<span className='px-1 sm:px-4 text-[25px] sm:text-[30px] lg:text-[40px]  font-bold  text-[#FF5C00]  '>  Friction</span>Learn
          <br></br>Dynamic Incubation Program</p>
...
">
  ...
  <div className="content">
    ...
    <p className="text-center text-[#1D2228] sm:text-[#1D2228] md:text-[#FF5C00] md:text-[18px]  sm:text-[14px] text-[14px]  font-medium mt-[20px]">
      Join the incubation program to start your<br /> entrepreneurial journey.
    </p>
  </div>
</div>
        ...
        <div className='md:flex flex-row ml-[300px] mt-[-100px] sm:hidden hidden '>
          <img src={line} alt="" className='h-[192px] w-[8px] text-center -rotate-90' />
        </div>
        ...
        <div className="container one left-1/2 relative py-[10px] px-[50px] ml-[40px] w-[650px]  animate-movedown opacity-0  md:mt-[-150px]   mt-[100px] sm:mt-[100px] " style={{ animationDelay: '5s' }} >
          <div className="img absolute left-[-90px]  z-10">
            <img src={images.img6} alt="Operational Mechanism" className="w-[100px] h-[100px]" />
          </div>
          <div className="text-box  ml-[10px]  ">
            <div className="content">
              <h3 className=' middle-content  md:text-[22px] text-[20px] sm:text-[20px]  font-lato font-semibold text-[#241443]  text-center' >Interview by Mentors</h3>

              <p className='text-center   text-[#1D2228] sm:text-[#1D2228] md:text-[#FF5C00] md:text-[18px]  sm:text-[14px] text-[14px]  font-medium mt-[20px]'>Engage in one-on-one sessions with<br></br> industry mentors to refine your<br></br> business model..</p>
            </div>
          </div>
        </div>
        ...
        <div className='md:flex flex-row ml-[730px] mt-[-120px]   sm:hidden  hidden '>
          <img src={line} alt="" className='h-[252px] w-[8px] text-center rotate-90 ' />
        </div>
        ...
        <div className="container two right-0 relative py-[10px] pr-[50px]  w-[650px] mr-[350px]   animate-movedown  opacity-0 md:mt-[-210px]   mt-[100px] sm:mt-[100px]" style={{ animationDelay: '6s' }}>
          <div className="img absolute right-[40px] top-[32px] z-10">
            <img src={images.img7} alt="Operational Mechanism" className="w-[100px] h-[100px] mr-[60px] " />
          </div>
          <div className="text-box mr-[150px]   ">
            <div className="content">
              <h3 className='     middle-content   md:text-[22px] text-[20px] sm:text-[20px]  font-lato font-semibold ml-[10px] text-center   text-[#241443]' >Evaluation Process</h3>

              <p className='text-center   text-[#1D2228] sm:text-[#1D2228] md:text-[#FF5C00] md:text-[18px]  sm:text-[14px] text-[14px]  font-medium  mt-[20px]'>Receive feedback and guidance during <br></br>the evaluation of your business idea.</p>
            </div>
          </div>
        </div>
        ...
        <div className='md:flex felx-col  ml-[200px] mt-[20px]  hide-on-mobile  sm:hidden  hidden  '><img src={line} alt="" className='h-[150px] w-[13px] text-center' /></div>
        <div className='md:flex felx-row  ml-[300px] mt-[-100px]   hide-on-mobile sm:hidden  hidden'><img src={line} alt="" className='h-[192px] w-[8px] text-center -rotate-90 ' /></div>




        {/* two right */}
        <div className="container one left-1/2 relative py-[10px] px-[50px] ml-[40px] w-[650px]  animate-movedown opacity-0   mb-[100px]  md:mt-[-170px]   mt-[100px] sm:mt-[100px]" style={{ animationDelay: '7s' }}>
          <div className="img absolute left-[-90px] top-[32px] z-10">
            <img src={images.img8} alt="Operational Mechanism" className="w-[100px] h-[100px]" />
          </div>
          <div className="text-box  ml-[20px]  ">
            <div className="content">
              <h3 className='  middle-content  md:text-[22px] text-[20px] sm:text-[20px]  font-lato font-semibold  text-center  text-[#241443] ' >Finalizing</h3>

              <p className='text-center   text-[#1D2228] sm:text-[#1D2228] md:text-[#FF5C00] md:text-[18px]  sm:text-[14px] text-[14px]  font-medium mt-[20px]'>Finalize your business plan and prepare<br></br> for presentation.</p>
            </div>
          </div>
        </div>
        ...
        <div className='flex flex-col  ml-[850px] mt-[-10px]   hide-on-mobile  '><img src={line} alt="" className='h-[150px] w-[13px] text-center' /></div>
        <div className='flex flex-row  ml-[760px] mt-[-100px]    hide-on-mobile  '><img src={line} alt="" className='h-[192px] w-[8px] text-center rotate-90 ' /></div>
        ...
        <div className="container two right-0 relative py-[10px] pr-[50px] w-[650px] mr-[350px] animate-movedown opacity-0 mb-[100px] mt-[-200px]" style={{ animationDelay: '8s' }}>
          ...
          <div className="text-box mr-[150px]   ">
            <div className="content">
              <h3 className='  middle-content md:text-[22px] text-[20px] sm:text-[20px]  font-lato font-semibold ml-[10px] text-[#241443] text-center' >Selection</h3>

              <p className='text-center   text-[#1D2228] sm:text-[#1D2228] md:text-[#FF5C00] md:text-[18px]  sm:text-[14px] text-[14px]  font-medium  mt-[20px]'>Selected startups receive incubation<br></br> support based on potential and<br></br> feasibility.</p>
            </div>
          </div>
        </div>
